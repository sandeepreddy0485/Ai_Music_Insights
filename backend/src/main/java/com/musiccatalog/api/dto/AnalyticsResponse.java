...
public class AnalyticsResponse {
    ...
    public Map<String, Long> getReleaseYearDistribution() { return releaseYearDistribution; }
    public void setReleaseYearDistribution(Map<String, Long> releaseYearDistribution) { this.releaseYearDistribution = releaseYearDistribution; }
